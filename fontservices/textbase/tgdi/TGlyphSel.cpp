...
@SYMTestExpectedResults Gurumuki and Latin characters don¡¯t mess up. Gurmukhi phoneme doesn¡¯t combine with Latin into a new syllable, 
						Gurmukhi phoneme doesn¡¯t form a syllable with other Indic script.
@SYMPREQ 1922: Gurmukhi support
*/
...
@SYMTestExpectedResults 1.nukta is combined to the base consonant according to the returned shape info
						...
						7.The combination¡¯s character count, glyph count, glyph indices info is the same as  the single nukta¡¯s
@SYMPREQ 1922: Gurmukhi support
*/
...
@SYMTestExpectedResults Malayalam and Latin characters don¡¯t mess up. Malayalam phoneme doesn¡¯t combine with Latin into a new syllable, 
						Malayalam phoneme doesn¡¯t form a syllable with other Indic script.
@SYMPREQ 1922: Malayalam support
*/
...
@SYMTestExpectedResults 1.First sequence is equivalent to the second sequence 
						...
						5.0x0d4d is recognized as a Virama in first sequence, it¡¯s recognized as MATRA (mid-u sound) in the second sequence
						6.Virama and ZWJ is interpreted as Chillaksharam for the 6 consonants, for others it¡¯s not interpreted that way.
						...
						10.CA, BA, YA, VA double should result in a ligature, other consonants don¡¯t.
